...
var _screenFormUI = _interopRequireDefault(require("./screenFormUI"));

var _networkFormUI = _interopRequireDefault(require("./networkFormUI"));

var _appUtil = _interopRequireDefault(require("./appUtil"));
...
let header = (0, _util.createElement)('header', {}, b);
let menu = (0, _util.createMenuBar)(['Network', 'Screen', 'Bluetooth', 'Sound'], header);
...
const App = {
  start() {
    var networkMI = (0, _util.createMenuItem)(globalBox, 'Network Configuration');
    var get_network_config = fetch(_urls.default.get_network_config);
    get_network_config.then(response => response.json()).then(dataNetwork => {
      var get_wifiList = fetch(_urls.default.get_wifiList);
      get_wifiList.then(response => response.json()).then(wifiList => {
        App.netForm = new _networkFormUI.default(dataNetwork, wifiList, networkMI.content);
      });
    });
    ...
    var screenMI = (0, _util.createMenuItem)(globalBox, 'Screen Resolution Configuration');
    var get_screen_config = fetch(_urls.default.get_screen_config);
    get_screen_config.then(response => response.json()).then(dataScreen => {
      App.scrnForm = new _screenFormUI.default(dataScreen, screenMI.content);
      App.scrnForm.setOnClick(_appUtil.default.setOnClick);
    });
    ...
    btnResetNet.onClick(() => {
      window.location.reload(); //networkMI.content =defaultValuesNet;
    });
...
.then(response => response.json())
  .then((dataScreen) => {
	...
	*/
},{"./util":"4ba43b1ef261e6617e63062b8de9f094","./screenFormUI":"cede2f242bb7e158b25093b68939d6cb","./networkFormUI":"ff6a71fff3af343a1df1f3722745e8eb","./appUtil":"9635202ef4f713edc17a9253b1bbda67","../Serv/urls":"64f0db400ff05b1e1d36729c707d840b"}],"4ba43b1ef261e6617e63062b8de9f094":[function(require,module,exports) {
"use strict";
...
function createMenuItem(parentEl, title) {
...
function createMenuBar(title, parentEl, onMenuClick) {
  //console.log(title);
  for (var index = 0; index < title.length; index++) {
    ...
    bt.id = title[index];
    bt.name = title[index];
    bt.addEventListener('click', choiceMenu);

    if (onMenuClick) {
      MenuUI.setOnMenuClick(onMenuClick, bt);
    }
...
*/
},{}],"cede2f242bb7e158b25093b68939d6cb":[function(require,module,exports) {
"use strict";
...
},{"./button":"7b3639d18269cc89bc2853fc4a8a9397","./screenFormUtil":"31548be8984a1306b1a9e37ae8354936","./util":"4ba43b1ef261e6617e63062b8de9f094"}],"7b3639d18269cc89bc2853fc4a8a9397":[function(require,module,exports) {
"use strict";
...
var _default = Button;
exports.default = _default;
},{"./util":"4ba43b1ef261e6617e63062b8de9f094"}],"31548be8984a1306b1a9e37ae8354936":[function(require,module,exports) {
"use strict";
...
const ScreenFormUtil = {
  modesSelected(evt) {//console.log(evt.target.value);
  ...
  sendParams(params) {
    ...
    xhr.open("POST", _urls.default.update_screen_config, true);
...
var _default = URLS;
exports.default = _default;
},{}],"ff6a71fff3af343a1df1f3722745e8eb":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./networkFormUtil":"b91fcfdd711bbc3d68a3bf9d9447c142","./button":"7b3639d18269cc89bc2853fc4a8a9397","./result":"e2d3b075cb0f95ba217881a8dba01c87","./wifiListUtil":"ba92ee23cfee3b33a6a843caf405d7a1","./util":"4ba43b1ef261e6617e63062b8de9f094"}],"b91fcfdd711bbc3d68a3bf9d9447c142":[function(require,module,exports) {
"use strict";
...
const NetworkFormUtil = {
  ...
  loadParams() {
    const network_config_params = NetworkFormUtil.getParams(this.inputs); // .call(this);
  ...
  activeConnection(activeBox) {
    ...
    if (activeBox.target.dataset['type'] == 'wifi') {
      var select = [];
      Object.values(this.inputs[1]).forEach(param => {
        if (param.name == 'inputWifiList' || param.type == 'password') {
    ...
    this.resultNetForm.update(JSON.stringify(params));
...
},{"../Serv/urls":"64f0db400ff05b1e1d36729c707d840b"}],"e2d3b075cb0f95ba217881a8dba01c87":[function(require,module,exports) {
"use strict";
...
;
},{"../Serv/urls":"64f0db400ff05b1e1d36729c707d840b","./util":"4ba43b1ef261e6617e63062b8de9f094"}],"9635202ef4f713edc17a9253b1bbda67":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./screenFormUI":"cede2f242bb7e158b25093b68939d6cb","./networkFormUI":"ff6a71fff3af343a1df1f3722745e8eb","./button":"7b3639d18269cc89bc2853fc4a8a9397","./result":"e2d3b075cb0f95ba217881a8dba01c87","../Serv/urls":"64f0db400ff05b1e1d36729c707d840b"}]},{},["9bd8da33dda5445de448aada4b043998","117d340aac48b3532ba7fce0acd67995"], null)
